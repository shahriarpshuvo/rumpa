---
title: 'Fertility Testing in the US: What to Ask Your Doctor'
date: '2026-05-27'
description: >-
  Fertility testing US what to ask doctor: an OB-GYN's question script for your
  appointment, your insurer, and the lab. Tests, codes, and timing.
category: Preconception
thumbnail: /blog/us-fertility-testing-what-to-ask-thumbnail.jpg
tags:
  - Fertility-Testing
  - US-Pathway
  - Pre-Conception
...
<Callout type="note">Insurers do not agree on what "infertility" means. Some plans require 12 months of documented trying before they cover diagnostic tests; others accept 6 months at age 35+; a few cover testing only after a documented diagnosis. Always ask before booking the labs.</Callout>

## The 6 Core Tests You Should Expect

A complete first-pass fertility evaluation in the US covers six core tests. <Cite source="ASRM 2021" url="https://www.asrm.org/practice-guidance/practice-committee-documents/fertility-evaluation-of-infertile-women-a-committee-opinion-2021/" />The ASRM committee opinion on fertility evaluation sets the standard, and most US OB-GYNs and reproductive endocrinologists work from this list. ACOG's infertility workup guidance mirrors it, so you can quote either source if your doctor pushes back.
...
A clean mock script when you call to book: "Can you order AMH, day-3 FSH, LH and estradiol, TSH, prolactin, a pelvic ultrasound with antral follicle count, an HSG, and [a partner sperm analysis](/blog/sperm-analysis-partner-test) for my husband or partner?" Saying the list out loud, in this order, signals that you have done your homework and reduces the chance of a piecemeal workup spread across three visits.
...
<Callout type="clinical-tip">Patients who come to me printing out their question list get a noticeably better workup. The list is not pushy — it shows you are organised and you respect the appointment time. Most clinicians respond well to that.</Callout>
...
<Cite source="RESOLVE" url="https://resolve.org/learn/financial-resources/insurance-coverage/insurance-coverage-by-state/" />The RESOLVE state-by-state insurance coverage map is the cleanest summary of which states require infertility coverage and what is excluded. If treatment escalates to IVF, [IVF cost in the US and what insurance covers](/blog/ivf-cost-us) becomes the next phone call. Make it before you commit to a clinic, not after.
...
<Callout type="warning">Do not let a single low result trigger a panic decision. Reproductive endocrinology runs on patterns, not point estimates. A reasonable doctor will repeat any borderline result before recommending IVF.</Callout>
...
<Cite source="CDC" url="https://www.cdc.gov/art/artdata/index.html" />The CDC ART surveillance data lets you cross-check any clinic's IVF outcomes by age. If a clinic's quote sounds too good or its protocol sounds aggressive, the public CDC numbers are the cheapest sanity check available.
...
<FAQ question="How much does a full US fertility workup cost without insurance?">A complete first-pass workup (day-3 hormones, AMH, TSH, prolactin, ultrasound, HSG, and partner semen analysis) typically runs $1,000 to $2,500 self-pay depending on the lab and state. With insurance and an infertility diagnosis code, out-of-pocket cost can be a few hundred dollars or zero in mandate states.</FAQ>

<FAQ question="Do I need a referral to see a reproductive endocrinologist in the US?">In most states you can self-refer to a reproductive endocrinologist if you are paying out of pocket. HMO plans usually require a PCP or OB-GYN referral; PPO plans typically do not. Always call your plan before booking.</FAQ>

<FAQ question="Can my OB-GYN run a full fertility workup, or do I need an REI?">Many US OB-GYNs run the full first-pass workup and even start ovulation induction. An REI becomes necessary for IVF, complex male factor, recurrent loss, or when basic treatment has not worked after 3-6 cycles.</FAQ>

<FAQ question="Is AMH covered by US insurance?">Coverage is inconsistent. Some plans cover AMH only with an infertility diagnosis code (ICD-10 N97.x); others classify it as screening and exclude it. Self-pay AMH is typically $75 to $250 through direct-to-consumer labs.</FAQ>

<FAQ question="What is California SB 729 and does it affect my coverage?">SB 729 (effective July 2025) requires large group health plans in California to cover diagnosis and treatment of infertility, including up to three IVF cycles. If your employer is California-based and on a large group plan, coverage may already apply.</FAQ>
