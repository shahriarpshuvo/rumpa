---
title: 'PCOS and TTC Tips: a Sequenced Plan from an OB-GYN'
date: '2026-05-24'
description: >-
  PCOS and TTC tips that actually help you conceive. A sequenced plan from an
  OB-GYN covering tracking, supplements, lifestyle, and when to escalate.
category: PCOS
thumbnail: /blog/pcos-ttc-tips-thumbnail.jpg
tags:
  - PCOS
  - TTC
  - Ovulation
...
Underneath that, insulin resistance drives higher circulating androgens, which disrupts the LH/FSH balance the ovary needs for a clean ovulation. That's why so much of PCOS fertility work is metabolic rather than gynaecological. Patients often ask, "[can you get pregnant with PCOS](/blog/can-you-get-pregnant-with-pcos)?" and the honest answer is yes, with the right sequence of steps.

<Callout type="note">PCOS is the leading cause of anovulatory infertility, but it isn't synonymous with infertility. Reframing it as a treatable timing problem changes the whole conversation.</Callout>
...
- Start a daily prenatal with **400 mcg folic acid** (5 mg if BMI is above 30 or you're on metformin) <Cite n="1" />
...
In clinic I usually suggest pairing serial LH testing across many days with BBT and mucus, then booking a mid-luteal progesterone after two or three cycles if things remain unclear. For a deeper walkthrough, see [tracking ovulation with PCOS](/blog/pcos-cycle-tracking-ovulation). The [ACOG patient guide on ovulation and fertility](https://www.acog.org/womens-health/faqs/evaluating-infertility) is a sensible plain-English starting point <Cite n="2" />.
...
What to skip: blanket "PCOS detox" kits, seed cycling, "hormone-balancing" teas, and anything claiming to cure PCOS. Compare the head-to-head trial data in [inositol vs metformin for PCOS fertility](/blog/inositol-vs-metformin-pcos) before adding either.

<Callout type="warning">Supplements are adjuncts, not substitutes for diagnosis or ovulation induction. If your cycles are absent or very irregular, supplements alone are unlikely to be enough.</Callout> <Cite n="3" />
...
- UK readers can compare doses and trade-offs in [letrozole vs clomid for PCOS ovulation](/blog/letrozole-vs-clomid-pcos)

The [NICE fertility assessment and treatment pathway](https://www.nice.org.uk/guidance/ng257) sets out the UK referral logic in detail <Cite n="4" />.

<Callout type="uk">**UK / NHS:** GP referral after 12 months of TTC (6 months if 35+ or with irregular cycles). NICE NG257 sets out ovulation induction and IVF pathways. The 2023 ESHRE international PCOS guideline informs most UK specialist practice.</Callout>

<Callout type="us">**US:** No referral needed; self-refer to an OB-GYN or REI. ASRM and ACOG both support letrozole as first-line ovulation induction for PCOS. Insurance coverage for ovulation induction varies by state and plan.</Callout>
...
- **Beyond 12 months:** Escalation to IUI or IVF; see [PCOS fertility treatment options explained](/blog/pcos-fertility-treatment-options) for how those decisions are usually made
...
<FAQ question="Can I conceive naturally with PCOS?">Many women with PCOS conceive naturally, especially if cycles ovulate even irregularly. Lifestyle work, weight optimisation where relevant, and good fertile-window tracking all help. If cycles are absent or very long, ovulation induction usually changes the picture quickly.</FAQ>

<FAQ question="How long should I try before seeing a doctor?">If your cycles are regular and you're under 35, the standard advice is 12 months. With PCOS or irregular cycles, don't wait beyond 6 months. If you're 35 or older with PCOS, book a GP or OB-GYN review now rather than waiting.</FAQ>

<FAQ question="Does losing weight always help PCOS fertility?">A modest 5 to 10% weight change improves ovulation in higher-BMI PCOS. Lean PCOS doesn't benefit from weight loss; the work there is insulin sensitivity, resistance training, and sleep, not the scale.</FAQ>

<FAQ question="Are OPKs reliable with PCOS?">Often not. Chronically elevated LH can trigger false-positive results across many days. Pair OPKs with cervical mucus tracking and a mid-luteal progesterone blood test for a clearer picture.</FAQ>

<FAQ question="Is letrozole better than clomid for PCOS?">Most international guidelines now recommend letrozole as first-line ovulation induction in PCOS, based on the PPCOS II trial showing higher live-birth rates than clomiphene. Clomid still has a role, but letrozole is usually the starting point.</FAQ>
