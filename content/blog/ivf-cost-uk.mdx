---
title: 'IVF cost UK private vs NHS: the true price, explained'
date: '2026-06-01'
description: >-
  IVF cost UK private vs NHS: an OB-GYN breaks down NICE eligibility, true
  private costs, hidden fees, and when private genuinely speeds things up.
category: Treatment
thumbnail: /blog/ivf-cost-uk-thumbnail.jpg
tags:
  - IVF
  - TTC
  - NHS-Pathway
...
This post breaks down what NICE actually recommends, what NHS funding looks like in practice, what a realistic private cycle costs, and which hidden fees catch patients out. If you're still deciding whether IVF is the right step at all, read [when to consider IVF after TTC](/blog/when-to-consider-ivf-after-ttc) first.

## Why IVF cost in the UK is so confusing

The HFEA regulates clinics but doesn't set prices, so every clinic publishes its own packages. <Cite n="1" /> What's labelled as a "cycle" at one clinic may exclude medication, blood tests, viral screening, embryo storage, or anaesthesia. At another it may include some of those and not others.
...
NICE CG156 still recommends up to 3 full IVF cycles for women under 40, and 1 cycle for women aged 40 to 42 who meet specific criteria. <Cite n="2" /> That's the headline policy and it hasn't changed in years.

Reality is messier. Funding decisions sit with Integrated Care Boards (ICBs), and the spread is wide. Roughly 72 percent of ICBs fund just 1 cycle, and only around 10 percent fund the full 3 NICE recommends. <Cite n="3" /> So does the NHS pay for IVF in all areas? Short answer, no, and the "postcode lottery" label exists for a reason.
...
For NHS IVF eligibility, the only reliable source for your area is your GP or your local ICB's website. Before any of this, you'll need a workup, which usually starts with [the NHS fertility testing pathway](/blog/nhs-fertility-testing).
...
If you're weighing IUI as a stepping stone, see [whether IUI is worth trying first](/blog/iui-vs-ivf). IUI runs roughly £800 to £1,500 per cycle privately and can shift the maths in some diagnoses.
...
The HFEA runs a traffic-light rating system for IVF add-ons. Most sit at amber or red, meaning evidence either doesn't support them or actively suggests they don't help live birth rates. <Cite n="4" />
...
If you do go private, [first IVF cycle prep](/blog/first-ivf-cycle-prep) covers what to do in the weeks before stimulation starts.
...
<FAQ question="How much does one IVF cycle cost in the UK in 2026?">
...
<FAQ question="Does the NHS pay for IVF in all areas?">
...
<FAQ question="Does going private speed things up?">
...
<FAQ question="What are refund or multi-cycle packages worth?">
...
<FAQ question="What happens if my first cycle fails on the NHS?">
