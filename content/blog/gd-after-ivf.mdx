...
PCOS is the one I flag most often, because patients with PCOS who go through IVF often assume the risk conversation is about IVF. It's mostly about PCOS. The [PCOS and gestational diabetes link](/blog/pcos-and-gd-link) is one of the strongest in pregnancy medicine, and IVF doesn't erase it.
