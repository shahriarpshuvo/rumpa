...
## Overview
- **Brand:** Dr. Rezwana Rumpa
- **Total planned posts:** 50
- **Cornerstones:** 7
- **Clusters:** 6 (A1, A2, B, C1+C2, D, E, F — see clusters below)
- **Publishing window:** 2026-05-15 → 2026-06-15 (32 days)
- **Cadence:** 2 posts/day for first 18 days (May 15 – Jun 1), then 1/day for last 14 days (Jun 2 – Jun 15)
- **Last updated:** 2026-05-17

### Publishing strategy
- **Phase 1 (Days 1-14, May 15-28):** Front-load ✅ low-KGR FAQs + spokes for fast indexation and ranking wins
- **Phase 2 (Days 15-18, May 29-Jun 1):** Launch ⚠️ moderate-difficulty cornerstones + supporting posts
- **Phase 3 (Days 19-32, Jun 2-15):** Remaining ⚠️ + 🔴 head-term posts (need topical authority built first)
- **Retro-link rule:** When a cornerstone publishes, retro-link existing spokes/FAQs to it (per WRITING_STYLE.md internal linking rules)

---

## Topic Clusters

### Cluster A1 — TTC Fundamentals
- **Cornerstone:** trying-to-conceive-tips-first-6-months (Post #1)
- **Spokes:** #2, #3, #4, #5, #6

### Cluster A2 — Getting Pregnant Fast
- **Cornerstone:** how-to-get-pregnant-fast (Post #7)
- **Spokes:** #8, #9, #10

### Cluster B — When to Escalate
- **Cornerstone:** when-to-see-fertility-specialist (Post #11)
- **Spokes:** #12, #13, #14

### Cluster C1 — PCOS Fertility (Conception)
- **Cornerstone:** can-you-get-pregnant-with-pcos (Post #15)
- **Spokes:** #16, #17, #18, #19

### Cluster C2 — PCOS Fertility (Treatment)
- **Cornerstone:** pcos-fertility-treatment-options (Post #20)
- **Spokes:** #21, #22, #23, #24, #25, #26

### Cluster D — IVF Decisions
- **Cornerstone:** when-to-consider-ivf-after-ttc (Post #27)
- **Spokes:** #28, #29, #30, #31, #32, #33, #34

### Cluster E — Gestational Diabetes
- **Cornerstone:** gestational-diabetes-diet-plan (Post #35)
- **Spokes:** #36, #37, #38, #39, #40, #41 (C↔E bridge), #42

### Cluster F — Pre-conception
- **Cornerstone:** pre-conception-health-checklist (Post #43)
- **Spokes:** #44, #45, #46, #47, #48, #49, #50
...
## Date Sanity Check
- May 15-28 (14 days): 28 posts (2/day) — all ✅
- May 29 – Jun 1 (4 days): 8 posts (2/day) — ⚠️ start + first cornerstones
- Jun 2-15 (14 days): 14 posts (1/day) — remaining ⚠️ + all 🔴
- Total: **50 posts ✓**

## Per-post Assets
- Keyword maps: `content/blog/<slug>/KEYWORDS.md`
- Media (cover + in-body images): `content/blog/<slug>/media/`
- Post body (to be written): `content/blog/<slug>/index.mdx` (Next.js MDX route convention; verify with engineering before final wiring)

## Migration note
Three legacy posts exist as flat files in `content/blog/`:
- `understanding-pcos-guide-ttc.mdx`
- `ovulation-induction-what-to-expect.mdx`
- `preconception-health-checklist.mdx`

Recommendation: migrate to nested-folder structure (`content/blog/<slug>/index.mdx`) and back-fill `KEYWORDS.md` for each. Track as separate engineering task — not in this content program.
