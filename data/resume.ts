export const DATA = {
  ...
  testimonials: [
    ...
    {
      name: "Sophie M.",
      role: "IVF Patient · Mum to twins",
      location: "Bristol, UK",
      text: "Two failed cycles before her — one successful with her. Dr. Rumpa took the time to re-investigate the basics nobody had checked. I trust her clinical judgement completely.",
      rating: 5,
    },
    {
      name: "Priya S.",
      role: "Endometriosis · TTC",
      location: "Edinburgh, UK",
      text: "Honest, evidence-led, and genuinely kind. She explained options without pressure and treated us like partners, not patients on a conveyor belt. Worth every minute of the journey.",
      rating: 5,
    },
  ],
  education: [
  ...
  professionalExperience: [
    {
      ...
      hospital: "Monno Medical College",
      duration: "1.5 Years",
    },
    {
